...
/** Allowed Content Types of the FulcrumSpace taxonomy. */
export enum ContentTypesOfFulcrumSpaceEnum {
  /** The Type of Content object */
  FulcrumPage = 'FULCRUM_PAGE'
}
...
/** Input for the createFulcrumPage mutation. */
export type CreateFulcrumPageInput = {
  ...
  /** Set connections between the FulcrumPage and FulcrumSpaces */
  fulcrumSpaces?: InputMaybe<FulcrumPageFulcrumSpacesInput>;
...
/** The payload for the createFulcrumPage mutation. */
export type CreateFulcrumPagePayload = {
  __typename?: 'CreateFulcrumPagePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The Post object mutation type. */
  fulcrumPage?: Maybe<FulcrumPage>;
};

/** Input for the createFulcrumSpace mutation. */
export type CreateFulcrumSpaceInput = {
  /** The slug that the fulcrum_space will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** The description of the fulcrum_space object */
  description?: InputMaybe<Scalars['String']>;
  /** The name of the fulcrum_space object to mutate */
  name: Scalars['String'];
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars['String']>;
};

/** The payload for the createFulcrumSpace mutation. */
export type CreateFulcrumSpacePayload = {
  __typename?: 'CreateFulcrumSpacePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The created fulcrum_space */
  fulcrumSpace?: Maybe<FulcrumSpace>;
};
...
/** Input for the deleteFulcrumPage mutation. */
export type DeleteFulcrumPageInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']>;
  /** The ID of the FulcrumPage to delete */
  id: Scalars['ID'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']>;
};

/** The payload for the deleteFulcrumPage mutation. */
export type DeleteFulcrumPagePayload = {
  __typename?: 'DeleteFulcrumPagePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']>;
...
/** Input for the deleteFulcrumSpace mutation. */
export type DeleteFulcrumSpaceInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** The ID of the FulcrumSpace to delete */
  id: Scalars['ID'];
};

/** The payload for the deleteFulcrumSpace mutation. */
export type DeleteFulcrumSpacePayload = {
  __typename?: 'DeleteFulcrumSpacePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']>;
...
export type FulcrumPage = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & MenuItemLinkable & Node & NodeWithAuthor & NodeWithComments & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithPageAttributes & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & NodeWithTrackbacks & Previewable & UniformResourceIdentifiable & {
  ...
  /** Connection between the FulcrumPage type and the Comment type */
  comments?: Maybe<FulcrumPageToCommentConnection>;
   ...
   */
  fulcrumPageId: Scalars['Int'];
  /** Connection between the FulcrumPage type and the FulcrumSpace type */
  fulcrumSpaces?: Maybe<FulcrumPageToFulcrumSpaceConnection>;
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']>;
  /** The globally unique identifier of the fulcrum_page object. */
  id: Scalars['ID'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean'];
  ...
  /** Connection between the FulcrumPage type and the FulcrumPage type */
  preview?: Maybe<FulcrumPageToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']>;
  ...
  /** Connection between the FulcrumPage type and the FulcrumPage type */
  revisions?: Maybe<FulcrumPageToRevisionConnection>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']>;
  /** The current status of the object */
  status?: Maybe<Scalars['String']>;
  /** The template assigned to a node of content */
  template?: Maybe<ContentTemplate>;
  /** Connection between the FulcrumPage type and the TermNode type */
  terms?: Maybe<FulcrumPageToTermNodeConnection>;
...
/** The FulcrumPage type */
export type FulcrumPageAncestorsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The FulcrumPage type */
export type FulcrumPageChildrenArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The FulcrumPage type */
export type FulcrumPageCommentsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<FulcrumPageToCommentConnectionWhereArgs>;
};


/** The FulcrumPage type */
export type FulcrumPageContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The FulcrumPage type */
export type FulcrumPageEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The FulcrumPage type */
export type FulcrumPageEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The FulcrumPage type */
export type FulcrumPageExcerptArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The FulcrumPage type */
export type FulcrumPageFulcrumSpacesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<FulcrumPageToFulcrumSpaceConnectionWhereArgs>;
};


/** The FulcrumPage type */
export type FulcrumPageRevisionsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<FulcrumPageToRevisionConnectionWhereArgs>;
};


/** The FulcrumPage type */
export type FulcrumPageTermsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<FulcrumPageToTermNodeConnectionWhereArgs>;
};


/** The FulcrumPage type */
export type FulcrumPageTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to FulcrumPage Nodes */
export type FulcrumPageConnection = {
  /** A list of edges (relational context) between RootQuery and connected FulcrumPage Nodes */
  edges: Array<FulcrumPageConnectionEdge>;
  /** A list of connected FulcrumPage Nodes */
  nodes: Array<FulcrumPage>;
  /** Information about pagination in a connection. */
  pageInfo: FulcrumPageConnectionPageInfo;
};

/** Edge between a Node and a connected FulcrumPage */
export type FulcrumPageConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']>;
  /** The connected FulcrumPage Node */
  node: FulcrumPage;
};

/** Page Info on the connected FulcrumPageConnectionEdge */
export type FulcrumPageConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Set relationships between the FulcrumPage to FulcrumSpaces */
export type FulcrumPageFulcrumSpacesInput = {
  /** If true, this will append the FulcrumSpace to existing related FulcrumSpaces. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<FulcrumPageFulcrumSpacesNodeInput>>>;
};

/** List of FulcrumSpaces to connect the FulcrumPage to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type FulcrumPageFulcrumSpacesNodeInput = {
  /** The description of the FulcrumSpace. This field is used to set a description of the FulcrumSpace if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']>;
  /** The ID of the FulcrumSpace. If present, this will be used to connect to the FulcrumPage. If no existing FulcrumSpace exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']>;
  /** The name of the FulcrumSpace. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars['String']>;
  /** The slug of the FulcrumSpace. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
  slug?: InputMaybe<Scalars['String']>;
};

/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum FulcrumPageIdType {
  /** Identify a resource by the Database ID. */
  DatabaseId = 'DATABASE_ID',
  /** Identify a resource by the (hashed) Global ID. */
  Id = 'ID',
...
/** Connection between the FulcrumPage type and the Comment type */
export type FulcrumPageToCommentConnection = CommentConnection & Connection & {
  __typename?: 'FulcrumPageToCommentConnection';
  /** Edges for the FulcrumPageToCommentConnection connection */
  edges: Array<FulcrumPageToCommentConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Comment>;
  /** Information about pagination in a connection. */
  pageInfo: FulcrumPageToCommentConnectionPageInfo;
};

/** An edge in a connection */
export type FulcrumPageToCommentConnectionEdge = CommentConnectionEdge & Edge & {
  __typename?: 'FulcrumPageToCommentConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node: Comment;
...
/** Page Info on the &quot;FulcrumPageToCommentConnection&quot; */
export type FulcrumPageToCommentConnectionPageInfo = CommentConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'FulcrumPageToCommentConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Arguments for filtering the FulcrumPageToCommentConnection connection */
export type FulcrumPageToCommentConnectionWhereArgs = {
  /** Comment author email address. */
  authorEmail?: InputMaybe<Scalars['String']>;
  /** Array of author IDs to include comments for. */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
...
/** Connection between the FulcrumPage type and the FulcrumSpace type */
export type FulcrumPageToFulcrumSpaceConnection = Connection & FulcrumSpaceConnection & {
  __typename?: 'FulcrumPageToFulcrumSpaceConnection';
  /** Edges for the FulcrumPageToFulcrumSpaceConnection connection */
  edges: Array<FulcrumPageToFulcrumSpaceConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<FulcrumSpace>;
  /** Information about pagination in a connection. */
  pageInfo: FulcrumPageToFulcrumSpaceConnectionPageInfo;
};

/** An edge in a connection */
export type FulcrumPageToFulcrumSpaceConnectionEdge = Edge & FulcrumSpaceConnectionEdge & {
  __typename?: 'FulcrumPageToFulcrumSpaceConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node: FulcrumSpace;
...
/** Page Info on the &quot;FulcrumPageToFulcrumSpaceConnection&quot; */
export type FulcrumPageToFulcrumSpaceConnectionPageInfo = FulcrumSpaceConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'FulcrumPageToFulcrumSpaceConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Arguments for filtering the FulcrumPageToFulcrumSpaceConnection connection */
export type FulcrumPageToFulcrumSpaceConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']>;
...
/** Connection between the FulcrumPage type and the FulcrumPage type */
export type FulcrumPageToPreviewConnectionEdge = Edge & FulcrumPageConnectionEdge & OneToOneConnection & {
  __typename?: 'FulcrumPageToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']>;
  /** The node of the connection, without the edges */
  node: FulcrumPage;
...
/** Connection between the FulcrumPage type and the FulcrumPage type */
export type FulcrumPageToRevisionConnection = Connection & FulcrumPageConnection & {
  __typename?: 'FulcrumPageToRevisionConnection';
  /** Edges for the FulcrumPageToRevisionConnection connection */
  edges: Array<FulcrumPageToRevisionConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<FulcrumPage>;
  /** Information about pagination in a connection. */
  pageInfo: FulcrumPageToRevisionConnectionPageInfo;
};

/** An edge in a connection */
export type FulcrumPageToRevisionConnectionEdge = Edge & FulcrumPageConnectionEdge & {
  __typename?: 'FulcrumPageToRevisionConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node: FulcrumPage;
...
/** Page Info on the &quot;FulcrumPageToRevisionConnection&quot; */
export type FulcrumPageToRevisionConnectionPageInfo = FulcrumPageConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'FulcrumPageToRevisionConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Arguments for filtering the FulcrumPageToRevisionConnection connection */
export type FulcrumPageToRevisionConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars['Int']>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
...
/** Connection between the FulcrumPage type and the TermNode type */
export type FulcrumPageToTermNodeConnection = Connection & TermNodeConnection & {
  __typename?: 'FulcrumPageToTermNodeConnection';
  /** Edges for the FulcrumPageToTermNodeConnection connection */
  edges: Array<FulcrumPageToTermNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<TermNode>;
  /** Information about pagination in a connection. */
  pageInfo: FulcrumPageToTermNodeConnectionPageInfo;
};

/** An edge in a connection */
export type FulcrumPageToTermNodeConnectionEdge = Edge & TermNodeConnectionEdge & {
  __typename?: 'FulcrumPageToTermNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node: TermNode;
...
/** Page Info on the &quot;FulcrumPageToTermNodeConnection&quot; */
export type FulcrumPageToTermNodeConnectionPageInfo = PageInfo & TermNodeConnectionPageInfo & WpPageInfo & {
  __typename?: 'FulcrumPageToTermNodeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Arguments for filtering the FulcrumPageToTermNodeConnection connection */
export type FulcrumPageToTermNodeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']>;
...
/** Field Group */
export type FulcrumPage_Acffulcrumpage = AcfFieldGroup & {
  __typename?: 'FulcrumPage_Acffulcrumpage';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  isoverview?: Maybe<Scalars['Boolean']>;
...
export type FulcrumSpace = DatabaseIdentifier & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  __typename?: 'FulcrumSpace';
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Fulcrum Spaces&quot; was set to Show in GraphQL. */
  acfFulcrumSpace?: Maybe<FulcrumSpace_Acffulcrumspace>;
  /** Connection between the FulcrumSpace type and the ContentNode type */
  contentNodes?: Maybe<FulcrumSpaceToContentNodeConnection>;
  /** The number of objects connected to the object */
  count?: Maybe<Scalars['Int']>;
  /** The unique identifier stored in the database */
  databaseId: Scalars['Int'];
  ...
  /** Connection between the TermNode type and the EnqueuedStylesheet type */
  enqueuedStylesheets?: Maybe<TermNodeToEnqueuedStylesheetConnection>;
  /** Connection between the FulcrumSpace type and the FulcrumPage type */
  fulcrumPages?: Maybe<FulcrumSpaceToFulcrumPageConnection>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of databaseId
   */
  fulcrumSpaceId?: Maybe<Scalars['Int']>;
  /** The unique resource identifier path */
  id: Scalars['ID'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean'];
  ...
  /** An alphanumeric identifier for the object unique to its type. */
  slug?: Maybe<Scalars['String']>;
  /** Connection between the FulcrumSpace type and the Taxonomy type */
  taxonomy?: Maybe<FulcrumSpaceToTaxonomyConnectionEdge>;
  /** The name of the taxonomy that the object is associated with */
  taxonomyName?: Maybe<Scalars['String']>;
  /** The ID of the term group that this term object belongs to */
  termGroupId?: Maybe<Scalars['Int']>;
...
/** The FulcrumSpace type */
export type FulcrumSpaceContentNodesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<FulcrumSpaceToContentNodeConnectionWhereArgs>;
};


/** The FulcrumSpace type */
export type FulcrumSpaceEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The FulcrumSpace type */
export type FulcrumSpaceEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The FulcrumSpace type */
export type FulcrumSpaceFulcrumPagesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<FulcrumSpaceToFulcrumPageConnectionWhereArgs>;
};

/** Connection to FulcrumSpace Nodes */
export type FulcrumSpaceConnection = {
  /** A list of edges (relational context) between RootQuery and connected FulcrumSpace Nodes */
  edges: Array<FulcrumSpaceConnectionEdge>;
  /** A list of connected FulcrumSpace Nodes */
  nodes: Array<FulcrumSpace>;
  /** Information about pagination in a connection. */
  pageInfo: FulcrumSpaceConnectionPageInfo;
};

/** Edge between a Node and a connected FulcrumSpace */
export type FulcrumSpaceConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']>;
  /** The connected FulcrumSpace Node */
  node: FulcrumSpace;
};

/** Page Info on the connected FulcrumSpaceConnectionEdge */
export type FulcrumSpaceConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum FulcrumSpaceIdType {
  /** The Database ID for the node */
  DatabaseId = 'DATABASE_ID',
  /** The hashed Global ID */
  Id = 'ID',
...
/** Connection between the FulcrumSpace type and the ContentNode type */
export type FulcrumSpaceToContentNodeConnection = Connection & ContentNodeConnection & {
  __typename?: 'FulcrumSpaceToContentNodeConnection';
  /** Edges for the FulcrumSpaceToContentNodeConnection connection */
  edges: Array<FulcrumSpaceToContentNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ContentNode>;
  /** Information about pagination in a connection. */
  pageInfo: FulcrumSpaceToContentNodeConnectionPageInfo;
};

/** An edge in a connection */
export type FulcrumSpaceToContentNodeConnectionEdge = ContentNodeConnectionEdge & Edge & {
  __typename?: 'FulcrumSpaceToContentNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node: ContentNode;
...
/** Page Info on the &quot;FulcrumSpaceToContentNodeConnection&quot; */
export type FulcrumSpaceToContentNodeConnectionPageInfo = ContentNodeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'FulcrumSpaceToContentNodeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Arguments for filtering the FulcrumSpaceToContentNodeConnection connection */
export type FulcrumSpaceToContentNodeConnectionWhereArgs = {
  /** The Types of content to filter */
  contentTypes?: InputMaybe<Array<InputMaybe<ContentTypesOfFulcrumSpaceEnum>>>;
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']>;
...
/** Connection between the FulcrumSpace type and the FulcrumPage type */
export type FulcrumSpaceToFulcrumPageConnection = Connection & FulcrumPageConnection & {
  __typename?: 'FulcrumSpaceToFulcrumPageConnection';
  /** Edges for the FulcrumSpaceToFulcrumPageConnection connection */
  edges: Array<FulcrumSpaceToFulcrumPageConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<FulcrumPage>;
  /** Information about pagination in a connection. */
  pageInfo: FulcrumSpaceToFulcrumPageConnectionPageInfo;
};

/** An edge in a connection */
export type FulcrumSpaceToFulcrumPageConnectionEdge = Edge & FulcrumPageConnectionEdge & {
  __typename?: 'FulcrumSpaceToFulcrumPageConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node: FulcrumPage;
...
/** Page Info on the &quot;FulcrumSpaceToFulcrumPageConnection&quot; */
export type FulcrumSpaceToFulcrumPageConnectionPageInfo = FulcrumPageConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'FulcrumSpaceToFulcrumPageConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Arguments for filtering the FulcrumSpaceToFulcrumPageConnection connection */
export type FulcrumSpaceToFulcrumPageConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars['Int']>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
...
/** Connection between the FulcrumSpace type and the Taxonomy type */
export type FulcrumSpaceToTaxonomyConnectionEdge = Edge & OneToOneConnection & TaxonomyConnectionEdge & {
  __typename?: 'FulcrumSpaceToTaxonomyConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']>;
  /** The node of the connection, without the edges */
  node: Taxonomy;
...
/** Field Group */
export type FulcrumSpace_Acffulcrumspace = AcfFieldGroup & {
  __typename?: 'FulcrumSpace_Acffulcrumspace';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
...
export enum MediaItemSizeEnum {
  /** MediaItem with the getwid_base-cropped size */
  GetwidBaseCropped = 'GETWID_BASE_CROPPED',
  /** MediaItem with the getwid_base-large size */
  GetwidBaseLarge = 'GETWID_BASE_LARGE',
...
export type MenuItemObjectUnion = Category | FulcrumPage | FulcrumSpace | Page | Post | Tag;
...
export type RootMutation = {
  ...
  /** The createFulcrumPage mutation */
  createFulcrumPage?: Maybe<CreateFulcrumPagePayload>;
  /** The createFulcrumSpace mutation */
  createFulcrumSpace?: Maybe<CreateFulcrumSpacePayload>;
  ...
  /** The deleteFulcrumPage mutation */
  deleteFulcrumPage?: Maybe<DeleteFulcrumPagePayload>;
  /** The deleteFulcrumSpace mutation */
  deleteFulcrumSpace?: Maybe<DeleteFulcrumSpacePayload>;
  ...
  /** The updateFulcrumPage mutation */
  updateFulcrumPage?: Maybe<UpdateFulcrumPagePayload>;
  /** The updateFulcrumSpace mutation */
  updateFulcrumSpace?: Maybe<UpdateFulcrumSpacePayload>;
...
/** The root mutation */
export type RootMutationCreateFulcrumPageArgs = {
  input: CreateFulcrumPageInput;
};


/** The root mutation */
export type RootMutationCreateFulcrumSpaceArgs = {
  input: CreateFulcrumSpaceInput;
};
...
/** The root mutation */
export type RootMutationDeleteFulcrumPageArgs = {
  input: DeleteFulcrumPageInput;
};


/** The root mutation */
export type RootMutationDeleteFulcrumSpaceArgs = {
  input: DeleteFulcrumSpaceInput;
};
...
/** The root mutation */
export type RootMutationUpdateFulcrumPageArgs = {
  input: UpdateFulcrumPageInput;
};


/** The root mutation */
export type RootMutationUpdateFulcrumSpaceArgs = {
  input: UpdateFulcrumSpaceInput;
};
...
export type RootQuery = {
  ...
  /** An object of the FulcrumPage Type.  */
  fulcrumPage?: Maybe<FulcrumPage>;
  /**
   * A FulcrumPage object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  fulcrumPageBy?: Maybe<FulcrumPage>;
  /** Connection between the RootQuery type and the FulcrumPage type */
  fulcrumPages?: Maybe<RootQueryToFulcrumPageConnection>;
  /** A 0bject */
  fulcrumSpace?: Maybe<FulcrumSpace>;
  /** Connection between the RootQuery type and the FulcrumSpace type */
  fulcrumSpaces?: Maybe<RootQueryToFulcrumSpaceConnection>;
...
/** The root entry point into the Graph */
export type RootQueryFulcrumPageArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']>;
  id: Scalars['ID'];
  idType?: InputMaybe<FulcrumPageIdType>;
};


/** The root entry point into the Graph */
export type RootQueryFulcrumPageByArgs = {
  fulcrumPageId?: InputMaybe<Scalars['Int']>;
  id?: InputMaybe<Scalars['ID']>;
...
/** The root entry point into the Graph */
export type RootQueryFulcrumPagesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<RootQueryToFulcrumPageConnectionWhereArgs>;
};


/** The root entry point into the Graph */
export type RootQueryFulcrumSpaceArgs = {
  id: Scalars['ID'];
  idType?: InputMaybe<FulcrumSpaceIdType>;
};


/** The root entry point into the Graph */
export type RootQueryFulcrumSpacesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<RootQueryToFulcrumSpaceConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the FulcrumPage type */
export type RootQueryToFulcrumPageConnection = Connection & FulcrumPageConnection & {
  __typename?: 'RootQueryToFulcrumPageConnection';
  /** Edges for the RootQueryToFulcrumPageConnection connection */
  edges: Array<RootQueryToFulcrumPageConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<FulcrumPage>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToFulcrumPageConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToFulcrumPageConnectionEdge = Edge & FulcrumPageConnectionEdge & {
  __typename?: 'RootQueryToFulcrumPageConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node: FulcrumPage;
...
/** Page Info on the &quot;RootQueryToFulcrumPageConnection&quot; */
export type RootQueryToFulcrumPageConnectionPageInfo = FulcrumPageConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToFulcrumPageConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Arguments for filtering the RootQueryToFulcrumPageConnection connection */
export type RootQueryToFulcrumPageConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars['Int']>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
...
/** Connection between the RootQuery type and the FulcrumSpace type */
export type RootQueryToFulcrumSpaceConnection = Connection & FulcrumSpaceConnection & {
  __typename?: 'RootQueryToFulcrumSpaceConnection';
  /** Edges for the RootQueryToFulcrumSpaceConnection connection */
  edges: Array<RootQueryToFulcrumSpaceConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<FulcrumSpace>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToFulcrumSpaceConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToFulcrumSpaceConnectionEdge = Edge & FulcrumSpaceConnectionEdge & {
  __typename?: 'RootQueryToFulcrumSpaceConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node: FulcrumSpace;
...
/** Page Info on the &quot;RootQueryToFulcrumSpaceConnection&quot; */
export type RootQueryToFulcrumSpaceConnectionPageInfo = FulcrumSpaceConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToFulcrumSpaceConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Arguments for filtering the RootQueryToFulcrumSpaceConnection connection */
export type RootQueryToFulcrumSpaceConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']>;
...
export enum TaxonomyEnum {
  ...
  Category = 'CATEGORY',
  /** Taxonomy enum fulcrum_space */
  Fulcrumspace = 'FULCRUMSPACE',
...
/** The template assigned to the node */
export type Template_DocumentationPage = ContentTemplate & {
  __typename?: 'Template_DocumentationPage';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};

/** The template assigned to the node */
export type Template_EmptyPage = ContentTemplate & {
  __typename?: 'Template_EmptyPage';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};

/** The template assigned to the node */
export type Template_FrontPage = ContentTemplate & {
...
/** The template assigned to the node */
export type Template_ReactPressCanvas = ContentTemplate & {
  __typename?: 'Template_ReactPressCanvas';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};

/** The template assigned to the node */
export type Template_ReactPressFullWidth = ContentTemplate & {
  __typename?: 'Template_ReactPressFullWidth';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};
...
/** Input for the updateFulcrumPage mutation. */
export type UpdateFulcrumPageInput = {
  /** The userId to assign as the author of the object */
  authorId?: InputMaybe<Scalars['ID']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  ...
  /** Set connections between the FulcrumPage and FulcrumSpaces */
  fulcrumSpaces?: InputMaybe<FulcrumPageFulcrumSpacesInput>;
  /** The ID of the FulcrumPage object */
  id: Scalars['ID'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updateFulcrumPage mutation. */
export type UpdateFulcrumPagePayload = {
  __typename?: 'UpdateFulcrumPagePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The Post object mutation type. */
  fulcrumPage?: Maybe<FulcrumPage>;
...
/** Input for the updateFulcrumSpace mutation. */
export type UpdateFulcrumSpaceInput = {
  /** The slug that the fulcrum_space will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** The description of the fulcrum_space object */
  description?: InputMaybe<Scalars['String']>;
  /** The ID of the FulcrumSpace object to update */
  id: Scalars['ID'];
  /** The name of the fulcrum_space object to mutate */
  name?: InputMaybe<Scalars['String']>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
...
/** The payload for the updateFulcrumSpace mutation. */
export type UpdateFulcrumSpacePayload = {
  __typename?: 'UpdateFulcrumSpacePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The created fulcrum_space */
  fulcrumSpace?: Maybe<FulcrumSpace>;
...
export type User = Commenter & DatabaseIdentifier & Node & UniformResourceIdentifiable & {
  ...
  /** Connection between the User type and the FulcrumPage type */
  fulcrumPages?: Maybe<UserToFulcrumPageConnection>;
...
/** A User object */
export type UserFulcrumPagesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<UserToFulcrumPageConnectionWhereArgs>;
};
...
/** Connection between the User type and the FulcrumPage type */
export type UserToFulcrumPageConnection = Connection & FulcrumPageConnection & {
  __typename?: 'UserToFulcrumPageConnection';
  /** Edges for the UserToFulcrumPageConnection connection */
  edges: Array<UserToFulcrumPageConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<FulcrumPage>;
  /** Information about pagination in a connection. */
  pageInfo: UserToFulcrumPageConnectionPageInfo;
};

/** An edge in a connection */
export type UserToFulcrumPageConnectionEdge = Edge & FulcrumPageConnectionEdge & {
  __typename?: 'UserToFulcrumPageConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node: FulcrumPage;
...
/** Page Info on the &quot;UserToFulcrumPageConnection&quot; */
export type UserToFulcrumPageConnectionPageInfo = FulcrumPageConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'UserToFulcrumPageConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Arguments for filtering the UserToFulcrumPageConnection connection */
export type UserToFulcrumPageConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars['Int']>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
